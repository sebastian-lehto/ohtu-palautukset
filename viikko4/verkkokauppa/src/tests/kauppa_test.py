...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            ...
            if tuote_id == 2:
                return Tuote(2, "pallo", 10)
            if tuote_id == 3:
                return Tuote(3, "ydinrektori", 999)
    ...
    def test_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_parametreilla(self):
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu oikeilla parametereilla
        self.pankki_mock.tilisiirto.assert_called_with("pekka",ANY,"12345","33333-44455", 5)

    def test_tilisiirto_toimii_kaksi_eri_tuotetta(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_tilisiirto_toimii_kaksi_samaa_tuotetta(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
    ...
    def test_tilisiirto_toimii_toinen_tuote_loppu(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
